...
class TorchSACOptimizer(TorchOptimizer):
    ...
    def __init__(self, policy: TorchPolicy, trainer_params: TrainerSettings):
        ...
        self.actor_clip_norm = hyperparameters.actor_clip_norm
        self.critic_clip_norm = hyperparameters.critic_clip_norm
    ...
    def update(self, batch: AgentBuffer, num_sequences: int) -> Dict[str, float]:
        ...
        # Perform gradient clipping to prevent from exploding gradients
        critic_params = list(self.q_network.parameters()) + list(self._critic.parameters())
